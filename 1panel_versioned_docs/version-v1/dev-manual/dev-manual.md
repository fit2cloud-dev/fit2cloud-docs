...
:::
![img.png](/img/1panel-v1/dev-manual/open.png)  

### 3.2 新建 Go build 启动项

![img.png](/img/1panel-v1/dev-manual/go_build.png)
...
:::
![img.png](/img/1panel-v1/dev-manual/start.png)
...
:::note
    ...
    - 安装完成后，使用 npm run dev 命名启动前端,前端启动后即可通过 [http://localhost:4004/](http://localhost:4004/) 地址访问
