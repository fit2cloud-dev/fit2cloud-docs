...
:::
![img.png](/img/1panel-v1/containers/setting.png)
...
:::note
    ...
    - 面板设置中开启 IPv6，其中 fixed-cidr-v6 是上一步获取到的 IPv6 网段的子网（配置默认网络，前缀长度最大为 /80）。
        ![img.png](/img/1panel-v1/containers/ipv6-01.png)

    - 通过【网络】-【详情】检查是否生效。若生效，则 EnableIPv6 值为 true，IPAM.Config[1].Subnet 是上一步配置的 fixed-cidr-v6。
        ![img.png](/img/1panel-v1/containers/ipv6-02.png)

    - 创建 IPv6 网络。
        ![img.png](/img/1panel-v1/containers/ipv6-03.png)
