...
:::note
    针对 NVIDIA 显卡，用户可以在 [https://www.nvidia.com/en-us/drivers/](https://www.nvidia.com/en-us/drivers/) 网站查找对应显卡型号支持的驱动版本，并进行下载安装。
...
:::
![img.png](/img/1panel-v1/ai/gpu_monitor.png)
...
![img.png](/img/1panel-v1/ai/gpu_acceleration.png)
