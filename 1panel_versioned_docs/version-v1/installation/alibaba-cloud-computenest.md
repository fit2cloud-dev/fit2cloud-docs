...
:::
![alibabacloud_computenest_deploy_1.jpg](/img/1panel-v1/installation/alibabacloud_computenest_deploy_2.jpg)

:::note
    点击立即创建，等待服务实例创建完成。

:::
![alibabacloud_computenest_deploy_2.jpg](/img/1panel-v1/installation/alibabacloud_computenest_deploy_3.jpg)

:::note
    服务实例创建成功后，进入服务实例详情页。在概览页可获取1Panel面板登录信息，点击外网面板地址，登录1Panel面板。
   
:::
![alibabacloud_computenest_deploy_3.jpg](/img/1panel-v1/installation/alibabacloud_computenest_deploy_1.jpg)
