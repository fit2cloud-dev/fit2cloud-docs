...
:::
![轻量应用服务器-应用管理.png](/img/1panel-v1/installation/lighthouse-app-manage.png)
...
:::
![轻量应用服务器-防火墙.png](/img/1panel-v1/installation/lighthouse-firewall.png)
...
:::
![轻量应用服务器-查看登录信息.png](/img/1panel-v1/installation/lighthouse-login-info.png)

## 5 登录 1Panel 面板

:::note

    - 通过上一步获取到的 http://服务器外网IP:8090/安全入口 地址，访问面板管理页面，如：[http://172.16.10.1:8090/mm4h9iucdn](http://172.16.10.1:8090/mm4h9iucdn)
    - 输入帐号密码
