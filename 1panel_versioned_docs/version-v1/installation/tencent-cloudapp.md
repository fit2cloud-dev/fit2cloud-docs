...
:::
![腾讯云云应用-安装参数.png](/img/1panel-v1/installation/tencent-cloudapp-params.png)

:::note
    根据页面提示，选择 VPC类型、地域、计费类型及云服务器类型等参数后，点击 `下一步：确定资源` 进入订单确认页面。

:::
![腾讯云云应用-订单确认.png](/img/1panel-v1/installation/tencent-cloudapp-confirm.png)

:::note
    信息确认无误后，点击 `下一步：安装应用`，腾讯云将自动完成云服务器、安全组、公网 IP 等相关资源的创建及 1Panel 的安装配置。等待 1Panel 云应用部署完成后，页面将自动跳转到新部署的 1Panel 云应用详情页面。

:::
![腾讯云云应用-应用详情.png](/img/1panel-v1/installation/tencent-cloudapp-detail.png)
...
:::
![腾讯云云应用-应用信息.png](/img/1panel-v1/installation/tencent-cloudapp-appinfo.png)
