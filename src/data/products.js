 ...
 *
 * 各入口的链接与文案独立维护，展示顺序统一由 productOrder.js 定义。
 */
import {sortProducts} from './productOrder';

const HOME_PRODUCTS = sortProducts([
  {id: '1panel', name: '1Panel 面板', to: '/1panel/', desc: '现代化、开源的 Linux 面板', logo: '1panel-07-蓝色.png'},
  {id: 'ai-gateway', name: '1Panel AI 网关', to: '/ai-gateway/', desc: '企业级 AI 统一接入与治理平台', logo: '1panel-07-蓝色.png'},
  {id: 'jumpserver', name: 'JumpServer', to: '/jumpserver/', desc: '广受欢迎的开源堡垒机', logo: 'JumpServer-辅助图形-绿色.png'},
  {id: 'maxkb', name: 'MaxKB', to: '/maxkb/', desc: '强大易用的企业级智能体平台', logo: 'MaxKB-03.png'},
