...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image1_view_model_names.png" alt="查看模型名称"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image2_create_apikey.png" alt="创建 API Key"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image3_copy_apikey.png" alt="复制 API Key"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image4_workbuddy_custom_model.png" alt="配置自定义模型"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image5_select_custom_provider.png" alt="选择自定义提供商"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image6_fill_integration_config.png" alt="填写接入配置"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image7_save_and_test_model.png" alt="保存并测试模型"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image8_deepseek_harness_add_provider.png" alt="添加自定义提供方"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image9_fill_provider_config.png" alt="填写提供方配置"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image10_deepseek_select_test_model.png" alt="选择模型并测试"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image11_ccswitch_add_button.png" alt="点击添加"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image12_enter_apikey_enable_routing.png" alt="填写配置并启用路由"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image13_fetch_model_list_submit.png" alt="获取模型列表并提交"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image14_restart_codex_after_ccswitch.png" alt="重启 codex"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/1panel/ai/image15_codex_select_model_test.png" alt="codex 测试对话"/>
