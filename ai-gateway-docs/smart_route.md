...
<div align="center"><strong style="color:#000000">表 1  智能路由模块</strong></div>
...
![智能路由功能入口](/img/smart_route/image1_Smart_Routing_Entry.png)

<div align="center">图 1  智能路由功能入口</div>
...
![样本管理列表](/img/smart_route/image2_Sample_Management.png)

<div align="center">图 2  样本管理列表</div>

## 4.2 添加样本

单击 **添加样本**，在弹出的表单中填写样本信息后保存，即可新增一个路由样本。

![添加样本](/img/smart_route/image4_Add_Sample.png)

<div align="center">图 3  添加样本</div>

添加样本的表单字段说明如下：

<div align="center"><strong style="color:#000000">表 2  添加样本字段</strong></div>
...
> **提示**：可在样本列表中选择多条样本后，单击 **构建选中向量** 批量构建；单击 **构建全部向量** 可为全部样本一次性构建向量。

## 4.3 决策预览

单击 **决策预览**，可输入一条请求样本，先查看路由决策的预判结果，确认无误后再决定是否添加为正式样本。

![决策预览](/img/smart_route/image3_Decision_Preview.png)

<div align="center">图 4  决策预览</div>

决策预览支持按上下文路由选择分类，常用操作说明如下：

<div align="center"><strong style="color:#000000">表 3  决策预览操作</strong></div>
...
![决策日志列表](/img/smart_route/image5_Decision_Logs.png)

<div align="center">图 5  决策日志列表</div>

决策日志支持以下筛选条件：

<div align="center"><strong style="color:#000000">表 4  决策日志筛选条件</strong></div>
...
![决策详情](/img/smart_route/image6_Decision_Detail.png)

<div align="center">图 6  决策详情</div>

决策详情中的主要信息说明如下：

<div align="center"><strong style="color:#000000">表 5  决策详情字段</strong></div>
...
![统计概览](/img/smart_route/image7_Statistics.png)

<div align="center">图 7  统计概览</div>

## 6.1 核心指标

统计页顶部展示六项核心指标，说明如下：

<div align="center"><strong style="color:#000000">表 6  核心指标说明</strong></div>
...
<div align="center"><strong style="color:#000000">表 7  分布维度说明</strong></div>
