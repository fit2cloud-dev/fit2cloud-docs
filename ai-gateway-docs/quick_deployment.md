...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/quick_deployment/image7_view_model_names.png" alt="查看模型名称"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/quick_deployment/image8_create_apikey.png" alt="创建 API Key"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/quick_deployment/image9_copy_apikey.png" alt="复制 API Key"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/quick_deployment/image10_workbuddy_custom_model.png" alt="配置自定义模型"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/quick_deployment/image11_select_custom_provider.png" alt="选择自定义提供商"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/quick_deployment/image12_fill_integration_config.png" alt="填写接入配置"/>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/quick_deployment/image13_save_and_test_model.png" alt="保存并测试模型"/>
