...
![图 1  基础设置](ai-gateway-docs/static/img/settings/image1-Basic-Settings.png)
...
![图 2  性能设置](ai-gateway-docs/static/img/settings/image2-Performance-Settings.png)
...
![图 3  向量服务](ai-gateway-docs/static/img/settings/image3-Vector-Service.png)
...
![图 4  智能路由设置](ai-gateway-docs/static/img/settings/image4-Smart-Routing-Settings.png)
...
![图 5  内容合规设置](ai-gateway-docs/static/img/settings/image5-Content-Compliance-Settings.png)
...
![图 6  Elasticsearch 设置](ai-gateway-docs/static/img/settings/image6-Elasticsearch-Settings.png)
