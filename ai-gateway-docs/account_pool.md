...
![账号池列表](/img/account_pool/image1_account_pool_list.png)
...
![供应商下拉](/img/account_pool/image2_provider_dropdown.png)
...
![添加账号表单](/img/account_pool/image3_add_account_form.png)
...
![DeepSeek 账号表单](/img/account_pool/image4_deepseek_form.png)
...
![自定义供应商表单](/img/account_pool/image5_custom_provider_form.png)
...
![模型映射](/img/account_pool/image6_model_mapping.png)
