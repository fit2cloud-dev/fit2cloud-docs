...
<img src="/img/1panel/ai/image1_Overview_Full_Page.png" alt="截图" style={{display:"block", margin:"16px auto", maxWidth:"85%"}} />
...
<img src="/img/1panel/ai/image2_Gateway_Status_Module.png" alt="截图" style={{display:"block", margin:"16px auto", maxWidth:"85%"}} />

<div style={{textAlign:"center", color:"#8a8f99", fontSize:"14px", margin:"8px 0 24px"}}>图 2  网关状态模块</div>

各项指标说明如下：

<div style={{textAlign:"center", color:"#5c6370", fontSize:"14px", fontWeight:"600", margin:"16px 0 8px"}}>表 1  网关状态指标说明</div>

| 指标 | 说明 |
|---|---|
| 当前活跃用户 | 当前正在与网关交互的活跃用户数 |
| 当前流式请求 | 当前正在进行的流式请求数 |
| 当前网关并发 | 网关当前并发数 / 最大并发数上限 |
| 当前等待队列 | 当前排队等待处理的请求数 / 队列上限 |
...
<img src="/img/1panel/ai/image3_Model_Account_Concurrency_Module.png" alt="截图" style={{display:"block", margin:"16px auto", maxWidth:"85%"}} />
...
<img src="/img/1panel/ai/image4_User_Group_Concurrency_Module.png" alt="截图" style={{display:"block", margin:"16px auto", maxWidth:"85%"}} />

<div style={{textAlign:"center", color:"#8a8f99", fontSize:"14px", margin:"8px 0 24px"}}>图 4  用户组并发模块</div>

<div style={{textAlign:"center", color:"#5c6370", fontSize:"14px", fontWeight:"600", margin:"16px 0 8px"}}>表 4  用户组并发字段说明</div>
...
<div style={{textAlign:"center", color:"#5c6370", fontSize:"14px", fontWeight:"600", margin:"16px 0 8px"}}>表 5  用户组并发示例数据</div>
...
<img src="/img/1panel/ai/image5_Usage_Statistics_Module.png" alt="截图" style={{display:"block", margin:"16px auto", maxWidth:"85%"}} />
...
<div style={{textAlign:"center", color:"#5c6370", fontSize:"14px", fontWeight:"600", margin:"16px 0 8px"}}>表 6  用量统计指标说明</div>
...
<img src="/img/1panel/ai/image6_Request_Statistics_Module.png" alt="截图" style={{display:"block", margin:"16px auto", maxWidth:"85%"}} />

<div style={{textAlign:"center", color:"#8a8f99", fontSize:"14px", margin:"8px 0 24px"}}>图 6  请求统计模块</div>

<div style={{textAlign:"center", color:"#5c6370", fontSize:"14px", fontWeight:"600", margin:"16px 0 8px"}}>表 7  请求统计指标说明</div>
