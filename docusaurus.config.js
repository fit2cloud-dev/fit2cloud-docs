        ...
        items: [
          {to: '/', label: '首页', position: 'left'},
          {
            ...
            items: [
              ...
              {label: 'JumpServer · 广受欢迎的开源堡垒机', href: 'https://docs.jumpserver.org/zh/v4/'},
              {label: 'DataEase · 人人可用的开源 BI 工具', href: 'https://dataease.cn/docs/v2/'},
              {label: 'MaxKB · 强大易用的企业级智能体平台', href: 'https://maxkb.cn/docs/v2/'},
              {label: 'SQLBot · 基于大模型的智能问数系统', href: 'https://sqlbot.org/docs/v1/'},
              {label: 'Cordys CRM · 新一代开源 AI CRM 系统', href: 'https://cordys.cn/docs/'},
              {label: 'MeterSphere · 新一代的开源持续测试工具', href: 'https://metersphere.io/docs/v3.x/'},
              {label: 'Halo · 强大易用的开源建站工具', href: 'https://docs.halo.run/'},
            ],
          },
          {
