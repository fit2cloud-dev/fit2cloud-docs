...
**规则生效范围**：WAF 总开关和网站开关需要同时开启。全局设置中带有 **网站** 标识的项目用于新建网站的默认配置，已有网站仍需在 **网站设置** 中单独确认；网站设置只影响当前选择的网站。

## 3 版本能力

<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"16px 0 8px"}}>表 1 WAF 各版本能力对比</div>
...
具体配置方法参见 [黑白名单](././blackwhite)、[网站设置](././site) 和 [全局设置](././global)。
