...
![image-20251021154330947](/img/1panel/app/jumpserver.png)
<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 2 搜索 JumpServer 并安装</div>
...
![image-20251021160652472](/img/1panel/app/jumpserver_install.png)
<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 3 配置安装参数——安装 JumpServer Server 的参数配置</div>
...
<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 4 访问 JumpServer 服务界面</div>

返回应用商店，点击 **跳转** 即可访问 JumpServer 服务

![image-20251021162640135](/img/1panel/app/jumpserver_jump.png)
<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 5 访问 JumpServer 服务——打开 JumpServer 服务地址</div>

使用默认用户名: `admin`  密码: `ChangeMe`登录即可

![image-20251021162912802](/img/1panel/app/jumpserver_view.png)
<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 6 访问 JumpServer 服务界面</div>
